    ...
    return (
      <section className="section">
        <div className="details display-none">
          ...
          <a href="https://medium.com/@annelee_22736" target="_blank"><img src={medium} className="logo"/></a>
          <a href="https://github.com/hermy0211" target="_blank"><img src={github} className="logo"/></a>
        </div>
      </section>
    )
  }
